# microsoft.com API - Version cognitiveservices-ImageSearch
...
- **Version**: cognitiveservices-ImageSearch
- **File**: swagger.yaml
- **Original Path**: microsoft.com/cognitiveservices-ImageSearch/1.0/swagger.yaml
