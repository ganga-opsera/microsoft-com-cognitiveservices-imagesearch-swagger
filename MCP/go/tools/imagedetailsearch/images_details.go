...
func Images_detailsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		if val, ok := args["cab"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("cab=%v", val))
		}
		if val, ok := args["cal"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("cal=%v", val))
		}
		if val, ok := args["car"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("car=%v", val))
		}
		if val, ok := args["cat"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("cat=%v", val))
		}
		if val, ok := args["ct"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("ct=%v", val))
		}
		...
		if val, ok := args["imgUrl"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("imgUrl=%v", val))
		}
		if val, ok := args["insightsToken"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("insightsToken=%v", val))
		}
		if val, ok := args["modules"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("modules=%v", val))
		}
		...
		url := fmt.Sprintf("%s/images/details%s", cfg.BaseURL, queryString)
		...
		var result models.ImageInsights
...
func CreateImages_detailsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_images_details",
		mcp.WithDescription("The Image Detail Search API lets you search on Bing and get back insights about an image, such as webpages that include the image. This section provides technical details about the query parameters and headers that you use to request insights of images and the JSON response objects that contain them. For examples that show how to make requests, see [Searching the Web for Images](https://docs.microsoft.com/azure/cognitive-services/bing-image-search/search-the-web)."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Images_detailsHandler(cfg),
	}
}
