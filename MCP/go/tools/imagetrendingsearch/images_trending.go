...
func Images_trendingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/images/trending%s", cfg.BaseURL, queryString)
		...
		var result models.TrendingImages
...
func CreateImages_trendingTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    Images_trendingHandler(cfg),
	}
}
